...
Input(TextEditingController? _textEditingController, String? _label,
    ...
    bool? shadow = true}) {
  return Padding(
    padding: EdgeInsets.symmetric(vertical: Responsive.fontSize * 3),
    child: Container(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          border: boder == true
              ...
              : InputBorder.none,
          suffixIcon: suffix,
          contentPadding: EdgeInsets.fromLTRB(Responsive.fontSize * 5,
              Responsive.fontSize * 5, Responsive.fontSize * 5, 0),
